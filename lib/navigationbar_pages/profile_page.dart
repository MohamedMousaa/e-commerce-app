        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: const [
                      Text("Orders completed : 10" , style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold)),
                      Text("Orders processed : 2" , style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold))
                    ],
                  ),
              ...
              const ListTile(
                title: Text("DOo M7amed" , style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold),),
              ...
              const ListTile(
                title: Text("gm8255528@gmail.com" , style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold),),
              ...
              const ListTile(
                title: Text("Egypt,cairo" , style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold),),
